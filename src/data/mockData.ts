...
export const players: MockPlayer[] = [
    ...
    // Defenders
    { id: 4, name: "Bright Osayi-Samuel", position: "DEF", number: 21, status: "injured" },
    ...
    { id: 9, name: "Jayden Oosterwolde", position: "DEF", number: 24, status: "injured" },
    ...
    // Midfielders
    { id: 13, name: "Fred", position: "MID", number: 35, status: "fit" },
    ...
    { id: 16, name: "Mert Hakan Yandaş", position: "MID", number: 8, status: "suspended" },
    { id: 17, name: "İrfan Can Kahveci", position: "MID", number: 17, status: "injured" },
